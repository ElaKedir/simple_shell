...
/**
 * ela_add_node - A function that adds a node to the start of the list
 ...
 * Return: size of list
 */
list_t *ela_add_node(list_t **head, const char *str, int num)
{
	list_t *new_head;
 ...
 * Return: size of list
 */
list_t *ela_add_node_end(list_t **head, const char *str, int num)
{
